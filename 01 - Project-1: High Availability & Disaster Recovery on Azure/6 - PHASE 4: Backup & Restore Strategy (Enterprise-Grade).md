...
🧠 Interview Explanation (PITR)

I used Azure SQL Point-in-Time Restore to recover data from accidental deletion, restoring the database to a specific timestamp with minimal data loss.
